  	...
  	<div class="room_main">
  		<div v-for="(item, index) in roomList" :key="index"> 
    		...
    		<!-- <vue-scroll :ops="ops"> -->
	  		...
	  		<div style="position: relative" class="name_time" ref='picWrapper' @touchstart.stop.prevent="touchstart(index)" @touchend.stop.prevent="touchend(index)">
	...
	this.$nextTick(()=>{
     ...
     //用于初始化“商家实景”的横向滚动效果
      _initPics(){
        ...
        //   let margin = 6;
        //   //width是所有图片的宽度和以及margin的大小和
        //   let width = (picWidth + margin)* 18 - margin;
        //   // console.log(width);
        //   console.log(this.$refs)
        //   let divs= this.$refs.picList 
