  ...
  <div class="room" v-if="moblieShow">  
  	<div class="room_main">
  		<div v-for="(item, index) in roomList" :key="index"> 
			...
			<div v-if="showPhone">
				<!-- <vue-scroll :ops="ops"> -->
					<!-- <div class="name_time" v-if="showPhone"> -->
					<div class="name_time">
						<ul class="timeRange">
							<li v-for="(titem, tindex) in item.available_hours" :key="tindex">
								<span style="text-indent: -0.16rem;">{{titem.start_at}}
									<div class="sDiv"></div>
								</span> 
			...
			<div v-else>
				<div style="position: relative" class="name_timek" ref='picWrapper' @touchstart.stop.prevent="touchstart(index)" @touchend.stop.prevent="touchend(index)">
					<ul class="timeRange" ref='picList'>
						<li v-for="(titem, tindex) in item.available_hours" :key="tindex">
							<span style="text-indent: -0.16rem;">{{titem.start_at}}
								<div class="sDiv"></div>
							</span> 
