        ...
        <el-form ref="form" :label-position="labelPosition" :model="projectForm" label-width="122px" size="small">
          ...
          <div class="raw">
            ...
            <div class="raw-content">
              ...
              <el-form-item label="预立项项目编号" v-show="projectForm.beforeNum">
                <el-input v-model="projectForm.beforeNum" placeholder="请输入..." :disabled="true" ></el-input>
              </el-form-item>
                ...
                <div class="proj-stage" v-for="(ps, index) in projectForm.stage" :key="index">
                  <el-form-item label="项目阶段" class="flex-style left is-required">
                    ...
                    <el-form-item label="合计">
                      <el-input class="small-input-day" v-model="ps.days" placeholder="请输入..." ></el-input><span class="input-after">人天( {{ ps.days*8 }}小时 )</span>
                    </el-form-item>
              ...
              <transition-group name="fade-transform" mode="out-in">
                <div class="proj-stage" v-for="(ps, index) in projectForm.stage" :key="index">
                  <el-form-item label="项目阶段" class="flex-style left is-required">
                    ...
                    <el-form-item label="合计" class="small-input">
                      <el-input class="small-input-day" v-model="ps.days" placeholder="请输入..." :disabled="projectForm.canEdit" ></el-input><span class="input-after">人天( {{ ps.days*8 }}小时 )</span>
                    </el-form-item>
                  ...
                  <div class="" v-for="(pm, pindex) in ps.month" :key="pindex">
                    <el-form-item label="" class="small-input">
                      <span class="input-before">{{ pm.m | subYM }}月</span><el-input class="small-input-day" v-model="pm.days" placeholder="请输入..." :disabled="projectForm.canEdit" ></el-input><span class="input-after">人天( {{ pm.days*8 }}小时 )</span>
                    </el-form-item>
                    <el-form-item label="">
