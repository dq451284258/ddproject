        ...
        <el-form ref="form" :label-position="labelPosition" :model="projectForm" label-width="122px" size="small">
          <div class="raw">
            ...
            <div class="raw-content">
              ...
              <el-form-item label="预立项项目编号" v-show="projectForm.projType === 1">
                <el-input v-model="projectForm.beforeNum" placeholder="请输入..." ></el-input>
              </el-form-item>
              <el-form-item label="项目编号" v-show="projectForm.projType !== 1">
          ...
          <div class="raw">
            ...
            <div class="raw-content" v-else>
              <!-- <el-form-item label="人工成本总额" class="flex-style start">
                <el-input v-model="projectForm.memberCost" placeholder="请输入..." ></el-input><span class="input-after">元</span>
              </el-form-item> -->
              <transition-group name="fade-transform" mode="out-in">
                <div class="proj-stage" v-for="(ps, index) in projectForm.stage" :key="index">
                  <el-form-item label="项目阶段" class="flex-style left is-required">
                  ...
                  <div class="" v-for="(pm, pindex) in ps.month" :key="pindex">
                    <el-form-item label="" class="small-input">
                      <span class="input-before">{{ pm.m | subYM }}月</span><el-input class="small-input-day" :disabled="true" v-model="pm.days" placeholder="请输入..." ></el-input><span class="input-after">人天( {{ pm.days*8 }}小时 )</span>
                    </el-form-item>
                    <el-form-item label="">
                      <el-input v-model="pm.desc" type="textarea" placeholder="请输入预期成果... " maxlength="8000" ></el-input>
                    </el-form-item>
          ...
          <div class="raw">
            ...
            <div class="raw-content">
              <!-- <el-form-item label="总预算" class="flex-style left is-required">
                <el-input v-model="projectForm.budget" placeholder="请输入..." class="width-small money"></el-input> -->
              ...
              <el-form-item label="附件">
                <uploadFile :files="projectForm.files" @addFiles='addFiles' v-if="projectForm.loading" />
              </el-form-item>
              <el-form-item label="">
...
<script>
  ...
  import { getDetail, projectEdit, projectSubmit } from '@/api/project'
  ...
  export default {
    ...
    methods: {
      ...
      changeProjType(e) {
        if(e == 2) {
          this.$router.replace('/formalEdit/'+this.projectForm.id)
        }
