            ...
            <div class="raw-content">
              <el-form-item label="">
                <div class="contract-file">
                  ...
                  <div class="file-list">
                    <a :href="p.url" v-for="(p, index) in projectForm.interestfiles" :key="index"><span>{{ p.name }}</span></a>
                  </div>
                </div>
          ...
          <div class="raw">
            ...
            <div class="raw-content">
              ...
              <el-form-item label="项目类型" class="flex-style is-required">
                <el-select v-model="projectForm.projType" placeholder="预立项生产性项目" @change="changeProjType">
              ...
              <el-form-item label="项目名称" class="is-required">
                <el-input v-model="projectForm.name" placeholder="请输入..." maxlength="25" ></el-input>
              </el-form-item>
              <el-form-item label="业主名称">
                <el-input v-model="projectForm.ownerName" placeholder="请输入..." maxlength="25" ></el-input>
              </el-form-item>
              <el-form-item label="预立项项目编号" class="">
              ...
              <el-form-item label="项目概述">
                <el-input v-model="projectForm.desc" type="textarea" placeholder="包括立项目的、成果价值、工期情况能否满意、与协同部门分工情况等" maxlength="8000" ></el-input>
              </el-form-item>
          ...
          <div class="raw">
            ...
            <div class="raw-content" v-else>
              <el-form-item label="人工成本总额" class="flex-style start">
                <el-input v-model="projectForm.memberCost" placeholder="请输入..." @change="getTotalBudget" ></el-input><span class="input-after">元</span>
              </el-form-item>
              <transition-group name="fade-transform" mode="out-in">
                <div class="proj-stage" v-for="(ps, index) in projectForm.stage" :key="index">
                  <el-form-item label="项目阶段" class="flex-style left is-required">
                    ...
                    <el-form-item label="合计" class="small-input is-required">
                      <el-input class="small-input-day" type="number" v-model="ps.days" :disabled="true" placeholder="请输入..." ></el-input><span class="input-after">人天( {{ ps.days*8 }}小时 )</span>
                    </el-form-item>
                    <el-form-item label="阶段结算金额" class="small-input large-lable">
                      <el-input v-model="ps.price" placeholder="请输入..." ></el-input><span class="input-after">元</span>
                    </el-form-item>
                    <div class="clear-stage" v-show="index > 0" @click="clearStage(index)"><i class="el-icon-circle-close"></i></div>
                  </el-form-item>
                  <div class="" v-for="(pm, pindex) in ps.month" :key="pindex">
                    <el-form-item label="" class="small-input">
                      <span class="input-before">{{ pm.m | subYM }}月</span><el-input class="small-input-day" v-model="pm.days" :disabled="true" placeholder="请输入..." ></el-input><span class="input-after">人天( {{ pm.days*8 }}小时 )</span>
                    </el-form-item>
                    <el-form-item label="">
                      <el-input v-model="pm.desc" type="textarea" placeholder="请输入预期成果... " maxlength="8000" ></el-input>
                    </el-form-item>
            ...
            <div class="raw-content">
              <el-form-item label="总预算" class="flex-style left is-required">
                ...
                <!-- <el-form-item label="分包采购">
                  <el-input v-model="projectForm.purchase" placeholder="请输入..." class="width-small money"></el-input>
                </el-form-item> -->
              </el-form-item>
              <!-- <el-form-item label="采购比例">
                <el-input v-model="projectForm.purchaseScale" placeholder="请输入..." class="width-small scale"></el-input>
              </el-form-item> -->
                ...
                <el-table style="width: 100%" :span-method="arraySpanMethod" :data="projectForm.costTable" class="cost-table" >
                  ...
                  <el-table-column label="项目预算">
                    <el-table-column label="单价(元)">
                      <template slot-scope="scope">
                        <el-input type="text" v-model="scope.row.price" @change="getMoney(scope.$index, scope.row)"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column label="数量">
                      <template slot-scope="scope">
                        <el-input type="text" v-model="scope.row.num" @change="getMoney(scope.$index, scope.row)"></el-input>
                      </template>
                    </el-table-column>
              ...
              <el-form-item label="包采购 （签订采购合同）">
                <el-table style="width: 100%" :data="projectForm.buyTable" class="cost-table buy-table" >
                  ...
                  <el-table-column label="金额(元)">
                    <template slot-scope="scope">
                      <el-input type="text" v-model="scope.row.price" @change="getBuyTotal(scope.$index, scope.row)"></el-input>
                    </template>
                  </el-table-column>
                </el-table>
              </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      changeProjType(e) {
        if(e != 2) {
          this.$router.replace('/create/'+this.projectForm.id)
        }
